...
Implementation docs for Phase 0 corporate actions (splits, dividends, stateless design).
...
**Session notes (archived):** [../archive/NIGHT_SESSION_SUMMARY.md](../archive/NIGHT_SESSION_SUMMARY.md), [../archive/NEW_FILES.md](../archive/NEW_FILES.md)
